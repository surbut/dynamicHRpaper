...
hazards <- readRDS("output/hazards_rate_UKB_amit_EQ_withPCcorrection_2.rds")
upperbound <- readRDS("output/hazards_rate_upperbound_amit_EQ_withPCcorrection_2.rds")
lowerbound <- readRDS("output/hazards_rate_lowerbound_amit_EQ_withPCcorrection_2.rds")
...
saveRDS(r2_ukb_all, "output/r2_withPC_eq.rds")
...
ggsave(r2_ukb_all, filename = paste0(fig_path, "r2_ukb_all_2.tiff"), dpi = 300, width = 6, height = 6)
```
