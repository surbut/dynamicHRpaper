...
hazards=data.frame(readRDS("output/hazards_rate_UKB_amit_EQ_withPCcorrection.rds"))
upperbound=data.frame(readRDS("output/hazards_rate_upperbound_amit_EQ_withPCcorrection.rds"))
lowerbound=data.frame(readRDS("output/hazards_rate_lowerbound_amit_EQ_withPCcorrection.rds"))
...
colnames(hrmat)=colnames(ormat)=colnames(r2mat)=c("Polygenic risk score","Pooled cohort equations","LDL Cholesterol","Smoking","Age","Systolic blood pressure","Diabetes mellitus","Body Mass Index","Male Sex","HDL cholesterol","Total cholesterol","age")
...
write.csv(r,"output/r2index_ukb_eq.csv",row.names = F)
...
tgt = c("Diabetes mellitus", "Smoking", "Polygenic risk score","Male Sex","Systolic blood pressure","HDL cholesterol", "Total cholesterol")
...
hr_ukb_all = dat %>%
  ...
  #geom_point(size = 0.5) +
  stat_smooth(method = "loess", span = 1) +
  scale_color_manual(values=col_p, drop=TRUE,breaks=c("Diabetes mellitus","Male Sex","Smoking","Polygenic risk score","LDL Cholesterol","Systolic blood pressure","Body Mass Index","Pooled cohort equations","Age","HDL cholesterol","Total cholesterol")) +
...
saveRDS(hall,"output/hall_withPC.rds")
#haz

saveRDS(r2,"output/r2_withPC.rds")
```
