...
hazards=data.frame(readRDS("output/hazards_rate_UKB_amit_EQ_withPCcorrection_2.rds"))
upperbound=data.frame(readRDS("output/hazards_rate_upperbound_amit_EQ_withPCcorrection_2.rds"))
lowerbound=data.frame(readRDS("output/hazards_rate_lowerbound_amit_EQ_withPCcorrection_2.rds"))
