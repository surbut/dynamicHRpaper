...
prs=ggplot(df, aes(x = prs_quant, y = agecat,fill=agecat)) + 
  geom_density_ridges() + theme_ridges()+labs(x = "Polygenic Score", y = "Density",fill="Age Category")+scale_fill_futurama()+theme_classic()
...
age=ggplot(df, aes(x = phenos.enrollment, y = prscat,fill=prscat)) + 
  geom_density_ridges() + theme_ridges()+labs(x = "Age of Enrollment (years)", y = "Density",fill="PRS Category")+scale_fill_jama()+theme_classic()
