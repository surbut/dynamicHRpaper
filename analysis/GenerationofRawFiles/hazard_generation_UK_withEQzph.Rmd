...
for (i in seq(1:nrow(dat))) {
  ...
  d=df[df$round_age==age&df$smoke==1,]
  d2 = df[df$round_age <= age&df$smoke==1,]
...
#hazardsnosmoke=hazards
#saveRDS(hazardsnosmoke,"../../output/hazards_rate_UKB_amit_EQ_no_smoke.rds")
