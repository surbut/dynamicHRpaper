...
length(which(rowSums(is.na(fwk))==0))
d2=fwk[which(rowSums(is.na(fwk))!=0),]
...
design <- tibble::tribble(
  ...
  "Study base with Outcome Data",        3821 ,   "Lack Total Cholesterol, HDL, Smoking, Systolic or Blood Pressure Information at baseline ",       161 ,
