...
hazards <- readRDS("output/hazards_rate_UKB_amit_EQ.rds")
upperbound <- readRDS("output/hazards_rate_upperbound_amit_EQ.rds")
lowerbound <- readRDS("output/hazards_rate_lowerbound_amit_EQ.rds")
...
# write.csv(reshape(r2s, direction = "wide", idvar = "age", timevar = "variable"), "output/r2index_ukb_eq_ateq.csv", row.names = FALSE)
```
