...
hazards=data.frame(readRDS("output/hazards_fh_EQ_withPC_corrections_2.rds"))
...
upperbound=data.frame(readRDS("output/hazards_rate_upperbound_fh_EQ_withPC_corrections_2.rds"))
lowerbound=data.frame(readRDS("output/hazards_rate_lowerbound_fh_EQ_withPC_corrections_2.rds"))
...
#saveRDS(r2,"output/r2fhs_withPC_eq.rds")
...
setwd("~/Dropbox (Personal)//rootfilesforbackup/dynamichr/")
